    ...
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Vue d'ensemble du système AY HR <span className="text-xs ml-2 px-2 py-1 bg-green-100 text-green-600 rounded-full">v3.7.0</span></p>
        </div>
      </div>
